...
(deftemplate curriculum "Representa la informacion del curriculum"
    ...
    (slot estudios (type SYMBOL) (allowed-values bachCiencias bachLetras ESO UNI)(default UNI))
    (slot acabada (type SYMBOL) (allowed-values SI NO)(default NO))
	;para trabajo
    (slot tipo (type SYMBOL) (allowed-values tecnico letras)(default tecnico))
    (slot docente (type SYMBOL) (allowed-values SI NO)(default NO))
    (slot investigador (type SYMBOL) (allowed-values SI NO)(default NO))
    (slot puesto (type SYMBOL) (allowed-values miembro directivo becario)(default miembro))
    (slot duracion (type INTEGER))
    (slot empresa (type SYMBOL) (allowed-values peque media grande)(default peque)))
...
(defrule pr_uni-fps_ciencias
    ...
    =>
    (retract ?h)
    (printout t "Ofertas relacionadas con enseñanzas tecnicas de estudios universitarios y formacion profesional de grado superior:
...
(defrule pr_uni-fps_letras
    ...
    =>
    (retract ?h)
    (printout t "Ofertas relacionadas con enseñanzas de letras de estudios universitarios y formacion profesional de grado superior
...
(defrule pr_bach-fpm
    ...
    =>
    (retract ?h)
    (printout t "Ofertas relacionadas con enseñanzas de bachillerato y formacion profesional de grado medio
...
Fabricación de productos cerámicos" crlf))
...
(defrule pr_becario
    ...
    =>
    (retract ?h)
    (printout t "Ofertas de becario para estudiantes universitarios
...
(defrule pr_tit_prof
    ...
    =>
    (retract ?h)
    (printout t "Ofertas de docencia e investigacion para titulados
...
(defrule pr_tit_tec_expBaja_peq
    ...
    =>
    (retract ?h)
    (printout t "Ofertas para titulados tecnicos con baja experiencia que han trabajado incluso de becario en empresas pequeñas
...
Observaciones:CONOCIMIENTOS MEDIO-AVANZADOS DE PHOTOSHOP, FREEHAND, ILUSTRATOR O COREL DRAW Y FLASH, PARA LA REALIZACIÓN DE DISEÑOS GRÁFICOS. USO DE PREMIERE O PROGRAMAS COMPATIBLES CON LA EDICIÓN AUDIOVISUAL. CONOCIMIENTOS BÁSICOS DE HTML." crlf))
...
(defrule pr_tit_tec_expMedia_peq
    ...
    =>
    (retract ?h)
    (printout t "Ofertas para titulados tecnicos con experiencia que han trabajado en empresas pequeñas
...
(defrule pr_tit_tec_expAlta_peq
    ...
    =>
    (retract ?h)
    (printout t "Ofertas para titulados tecnicos con alta experiencia que han trabajado incluso como directivo en empresas pequeñas
...
Observaciones:
ALTO NIVEL DE INGLÉS HABLADO Y ESCRITO. LINUX WORKSTATION/SERVER EXPERIENCIE. LAMP (LINUX, APACHE, MYSQL, PHP SETUPS) NETWORK EXPERIENCIE. ACTIONSCRIPT 3 PROGRAMMING. PHP CLASSES KNOWLEDGE. IT ADMINISTRATION; HELPDESK." crlf))
...
(defrule pr_tit_tec_expBaja
    ...
    =>
    (retract ?h)
    (printout t "Ofertas para titulados tecnicos con poca experiencia que han trabajado incluso de becario en empresas medias
...
(defrule pr_tit_tec_expMedia
    ...
    =>
    (retract ?h)
    (printout t "Ofertas para titulados tecnicos con experiencia media que han trabajado en empresas medianas
...
(defrule pr_tit_tec_expAlta
    ...
    =>
    (retract ?h)
    (printout t "Ofertas para titulados tecnicos con experiencia alta que han trabajado incluso como directivo en empresas medias
...
Ingeniero Técnico Industrial, Especialidad en Electricidad
Observaciones:
MANEJO PROGRAMA AUTOCAD. PERSONA RESPONSABLE. TURNO DE MAÑANA." crlf))
...
(defrule pr_tit_tec_expBaja_gran
    ...
    =>
    (retract ?h)
    (printout t "Ofertas para titulados tecnicos con poca experiencia que han trabajado incluso de becario en empresas grandes
...
Idiomas:
INGLÉS
Lectura:AVANZADO Conversación:AVANZADO Escritura:AVANZADO" crlf))
...
(defrule pr_tit_tec_expMedia_gran
    ...
    =>
    (retract ?h)
    (printout t "Ofertas para titulados tecnicos con experiencia media que han trabajado en empresas grandes
...
Ingeniero en Informática
Ingeniero Técnico en Informática de Gestión
Ingeniero Técnico en Informática de Sistemas" crlf))
...
(defrule pr_tit_tec_expAlta_gran
    ...
    =>
    (retract ?h)
    (printout t "Ofertas para titulados tecnicos con experiencia alta que han trabajado incluso como directivo en empresas grandes
...
(defrule pr_tit_let_expBaja_peq
    ...
    =>
    (retract ?h)
    (printout t "Ofertas para titulados de letras con baja experiencia que han trabajado incluso de becario en empresas pequeñas
...
Licenciado en Ciencias de Matemáticas. Estadística Matemática" crlf))
...
(defrule pr_tit_let_expMedia_peq
    ...
    =>
    (retract ?h)
    (printout t "Ofertas para titulados de letras con experiencia que han trabajado en  empresas pequeñas
...
(defrule pr_tit_let_expAlta_peq
    ...
    =>
    (retract ?h)
    (printout t "Ofertas para titulados de letras con alta experiencia que han trabajado incluso como directivo en empresas pequeñas
...
Licenciado en Ciencias Económicas y Empresariales" crlf))
...
(defrule pr_tit_let_expBaja
    ...
    =>
    (retract ?h)
    (printout t "Ofertas para titulados de letras con poca experiencia que han trabajado incluso de becario en empresas medias
...
(defrule pr_tit_let_expMedia
    ...
    =>
    (retract ?h)
    (printout t "Ofertas para titulados de letras con experiencia media que han trabajado en empresas medianas
...
(defrule pr_tit_let_expAlta
    ...
    =>
    (retract ?h)
    (printout t "Ofertas para titulados de letras con experiencia alta que han trabajado incluso como directivo en empresas medias
...
Disponibilidad: Todo el dia" crlf))
...
(defrule pr_tit_let_expBaja_gran
    ...
    =>
    (retract ?h)
    (printout t "Ofertas para titulados de letras con poca experiencia que han trabajado incluso de becario en empresas grandes
...
(defrule pr_tit_let_expMedia_gran
    ...
    =>
    (retract ?h)
    (printout t "Ofertas para titulados de letras con experiencia media que han trabajado en empresas grandes
...
(defrule pr_tit_let_expAlta_gran
    ...
    =>
    (retract ?h)
    (printout t "Ofertas para titulados de letras con experiencia alta que han trabajado incluso como directivo en empresas grandes
